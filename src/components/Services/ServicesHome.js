        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="single-cat text-center mb-50 border border-secondary">
                <div class="cat-icon">
                  <span class="flaticon-pen"><i class="fa-solid fa-globe"></i></span>
                </div>
                <div class="cat-cap">
                  <h5>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="single-cat text-center mb-50 border border-secondary">
                <div class="cat-icon">
                  <span class="flaticon-speaker"><i class="fa-solid fa-bullhorn"></i></span>
                </div>
                <div class="cat-cap">
                  <h5>
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="single-cat text-center mb-50 border border-secondary">
                <div class="cat-icon">
                  <span class="flaticon-portfolio"><i class="fa-solid fa-desktop"></i></span>
                </div>
                <div class="cat-cap">
                  <h5>
